##Script producing time series plots of energy consumption of household
...
legend(legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),"topright",lwd=1,col=c("BLACK","RED","BLUE"))
dev.off()
